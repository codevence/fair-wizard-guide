...
* Switched to semantic versioning (``MAJOR.MINOR``) for document template metamodel in order to avoid unnecessary changes in template. For example, template for 17.2 will work with FAIR Wizard that supports 17.MINOR where MINOR≥2; however, will not work with FAIR Wizard that supports 17.0 or 17.1. All older versions are considered as MAJOR with MINOR=0.
