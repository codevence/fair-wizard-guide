...
For **data stewards** and **admins**, *update available* may appear if there is a newer version of the knowledge model in the `FAIR Wizard Registry <https://registry.fair-wizard.com/>`__ (and if configured).
