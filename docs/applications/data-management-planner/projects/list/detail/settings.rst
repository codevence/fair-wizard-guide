...
*Unsupported metamodel* can appear, when the document template is not compatible with the version of |project_name|. Researchers should contact their Data Steward or Admin in this case.
