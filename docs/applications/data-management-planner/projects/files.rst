...
Users with the :ref:`Edit ALL Projects<roles>` role permission can quickly browse all files stored in the FAIR Wizard instance by navigating to :guilabel:`Files` from the projects menu. It is possible to search for a file by name or sort them using their creation timestamp, name or size.
