...
As admins, we can quickly browse all documents stored in the FAIR Wizard instance by navigating to :guilabel:`Documents` from the projects menu. It is possible to search for a document by name or sort them using their name or creation timestamp.
