...
If we want to let users select sharing options for their projects within the |project_name| instance, we can enable the **Project Sharing** feature. If it is disabled, the new projects will have the **Default Project Sharing** which is used when creating a new project:
