...
Users with the :ref:`Manage Document Templates<roles>` role permission can check and manage all document templates from the list accessible from the main menu via :guilabel:`Document Templates`. The list can be filtered and sorted by name.
