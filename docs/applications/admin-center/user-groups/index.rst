...
User Groups list allows administrators to see and manage all user groups in the FAIR Wizard. The list can be searched based using name fragment, and sorted via properties of user groups, name and date created.
