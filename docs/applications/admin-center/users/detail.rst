...
Default roles cover the common researcher, data steward, and admin workflows. Users with the :ref:`Manage Settings<roles>` role permission can also create custom roles when they need a different combination of permissions.
